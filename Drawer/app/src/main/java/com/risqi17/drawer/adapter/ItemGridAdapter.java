package com.risqi17.drawer.adapter;
...
/**
 * Created by Risqi17 on 23/05/2017.
 */
...
public class ItemGridAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        Picasso.with(context).load(items[position]).placeholder(ContextCompat.getDrawable(context, R.drawable.logo)).into(holder.imgItem);
        return view;
    }
