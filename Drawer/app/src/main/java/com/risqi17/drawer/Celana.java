...
public class Celana extends AppCompatActivity implements View.OnClickListener {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.PESAN_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        Toast.makeText(Celana.this,response,Toast.LENGTH_LONG).show();
                    }
                },
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Celana.this,error.toString(),Toast.LENGTH_LONG).show();
                    }
                }){
            @Override
